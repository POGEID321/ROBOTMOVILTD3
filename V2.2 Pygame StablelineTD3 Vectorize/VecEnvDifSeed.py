...
if __name__ == "__main__":
    ...
    model.load("td3_milimars_final", env=envs)

    model.set_logger(new_logger)

    # 💾 Callback para guardar modelos cada N pasos
    checkpoint_callback = CheckpointCallback(save_freq=500000, save_path="./models_sb3/2/", name_prefix="td3")

    # 🚀 Entrenamiento
    total_timesteps = 1500000  # equivalente a 1500 episodios * ~1000 steps
    model.learn(total_timesteps=total_timesteps, callback=checkpoint_callback)

    # 💾 Guardar modelo final
    model.save("td3_milimars_final2")
    envs.close()
